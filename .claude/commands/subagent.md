...
**Profile:** Match task domain -> eg `debugger`, `dx-optimizer`, or default `general-purpose`

**Skills:** Infer from task:
...
**For thorough review:** Spawn a code-reviewer subagent pointing at the report file instead of reviewing inline.

## Parallel Safety

- Non-overlapping file ownership per subagent
- YOU handle: pyproject.toml, configs, shared modules
- Consider worktrees for isolation
