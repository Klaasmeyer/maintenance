...
| `TypeError: unsupported operand` | Wrong types in operation |
| `KeyError` | Missing dict key - use .get() or check membership |
...
| `ValueError` | Wrong value passed - check input validation |
